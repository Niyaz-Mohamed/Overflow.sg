...
trialModels(predictionTimes=[0.5, 1.0, 2.0], dateRange=["2023-11-11", "2023-11-15"])
trialModels(predictionTimes=[0.5, 1.0, 2.0], dateRange=["2023-11-06", "2023-11-10"])
trialModels(predictionTimes=[0.5, 1.0, 2.0], dateRange=["2023-11-01", "2023-11-05"])
